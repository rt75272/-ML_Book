...
def clean_input(text):
    ...
    """
    # To keep things simple at the start, lets only keep ASCII characters.
    return str(text.encode().decode('ascii', errors='ignore'))

# Tokenizing Text. pg 48.
